...
public class TestDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        List<Test> tests = new ArrayList<>(List.of(
            ...
            new Test("Olympiad 1", Test.Difficulty.MEDIUM, "fun", "Math puzzles and brain teasers"),
            new Test("Olympiad 2", Test.Difficulty.MEDIUM, "fun", "Real-world math applications"),
            new Test("Olympiad 3", Test.Difficulty.MEDIUM, "fun", "Pattern recognition and logic"),
            new Test("Olympiad 4", Test.Difficulty.HARD, "fun", "Challenge problems"),
